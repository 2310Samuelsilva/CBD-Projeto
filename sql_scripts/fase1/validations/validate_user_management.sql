...
/*============================================================
  USER MANAGEMENT TEST SCRIPT (CLEANED & FIXED)
============================================================*/
...
INSERT INTO #test_vars VALUES (
    'testcustomer@example.com',  -- legacy/placeholder email
    'testuser2@example.com',     -- test AppUser email
    'MyTestPassword123',         -- test password
    'Favorite color?',           -- recovery question
    'Blue'                       -- recovery answer
);
GO
